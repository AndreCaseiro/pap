        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM salarios WHERE utilizadores_idLogin = (SELECT idlogin FROM utilizadores WHERE utilizador = '" . $_SESSION['utilizador'] . "')";
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th>Prémio Mensal Atribuído</th>";
                                    echo "</tr>";
                                echo "</thead>";
                                echo "<tbody>";
