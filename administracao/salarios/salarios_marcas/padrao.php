            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Salários Funcionários Padrão</h2>
                        ...
                        if(isset($_POST['pesquisar']))
                        {
                            ...
                            $query = "SELECT * FROM `salarios` WHERE fk_empresa = 2 AND CONCAT (`idsalarios`, `data_salario_base`, `utilizadores_idlogin`, `funcionarios_idfuncionarios`, `fk_empresa`, `fk_premios`, `fk_codvencimento`) LIKE '%".$valorPesquisar."%'";
                            $search_result = filterTable($query);

                        }
                         else {
                            $query = "SELECT * FROM `salarios` WHERE fk_empresa = 2";
                            $search_result = filterTable($query);
                        }
                ...
                ?>
                    ...
                    $sql = "SELECT * FROM salarios WHERE fk_empresa = 2";
