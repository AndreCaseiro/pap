                                ...
                                while($row = mysqli_fetch_array($search_result)){
                                    ...
                                    echo "<td>" . $linha1['nome'] . "</td>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='update.php?id=". $row['idfuncionarios'] ."' title='EditarSalario' data-toggle='tooltip'><span class='fa fa-pencil'></span></a>";
                                            echo "<a href='delete.php?id=". $row['idfuncionarios'] ."' title='EliminarSalario' data-toggle='tooltip'><span class='fa fa-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
