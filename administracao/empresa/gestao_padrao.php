            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Gastos da Empresa PADRÃO</h2>
                    ...
                    $sql = "SELECT preco_base FROM produtos WHERE ano_atual = 2019 AND empresa_idEmpresa = 2";
                    $sql2 = "SELECT salario_base FROM salarios WHERE ano_atual = 2019 AND fk_empresa = 2";
