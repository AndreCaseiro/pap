...
<body>
    <?php
        ...
        $sql_produtos = "SELECT SUM(produtos.preco_base) AS preco_base FROM produtos  WHERE produtos.ano_atual = '".$q."' AND empresa_idEmpresa = 1";
        $sql_salarios = "SELECT SUM(salarios.salario_base) AS salario_base FROM salarios WHERE salarios.ano_atual = '".$q."' AND fk_empresa = 1";
